      ...
      <div className="blur-sheet rounded-3xl mx-4 sm:mx-6 lg:mx-8 max-w-5xl w-full relative">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center space-x-2 space-x-reverse bg-white/20 backdrop-blur-xl border border-white/30 rounded-full px-6 py-3 mb-8"
          >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-7xl font-black mb-6 text-gray-800"
          >
          ...
          >
            <p className="text-lg lg:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed font-semibold mb-8">
              تیم حرفه‌ای، خدمات حرفه‌ای - راه‌حل‌های نوآورانه در حوزه فناوری اطلاعات سلامت
            </p>
